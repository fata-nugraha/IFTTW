...
public class ActiveFragment extends Fragment {
    ...
    @NonNull
    static ActiveFragment newInstance() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        routines = db.getAllActiveRoutine();
    }
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.active_fragment, container, false);
        RelativeLayout rl = root.findViewById(R.id.active_layout);
        ...
        for (Routine data : routines){
            RelativeLayout routine = (RelativeLayout) inflater.inflate(R.layout.routine2, container, false);
                ...
                case 4:
                    ...
                    cond.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(getActivity().getApplicationContext(), data.getCond().getLdt().toString(), 0).show();
                        }
                    });
                    break;
            ...
            switch (data.getAction().getId()){
                case 1:
                    ...
                    action.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Toast.makeText(getActivity().getApplicationContext(), data.getAction().getTitle(), 0).show();
                        }
                    });
                    break;
                case 2:
                ...
                case 3:
                    ...
                    action.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Toast.makeText(getActivity().getApplicationContext(), data.getAction().getWifiState(), 0).show();
                        }
                    });
                    break;
            }
            ...
            buttonA.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    db.changeState(data.getId(), Constant.ROUTINE_INACTIVE);
